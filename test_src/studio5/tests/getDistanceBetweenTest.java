...
/**
 * Methods that test the getDistanceBetween() method
 */
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class getDistanceBetweenTest {
	...
	public void testIdenticalPoints() {
		...
		assertEquals(0.0, // The value we expect to get (to pass the test)
				Methods.getDistanceBetween(1.0, 0.0, 1.0, 0.0), // The thing to test
	...
	public void testPointsA() {
		...
		assertEquals(1.0, Methods.getDistanceBetween(1.0, 0.0, 2.0, 0.0), 1e-5);
	}
	...
	public void testPointsB() {
		...
		assertEquals(2.0, Methods.getDistanceBetween(0.0, 1.0, 0.0, -1.0), 1e-5);
	}
	...
	public void testPointsC() {
		...
		assertEquals(5.0, Methods.getDistanceBetween(-1.0, -1.0, 2.0, 3.0), 1e-5);
	}
	...
	public void testPointsD() {
		...
		assertEquals(10.0, Methods.getDistanceBetween(0.0, 30.0, 0.0, 40.0), 1e-5);
	}
	...
	public void testPointsE() {
		// TODO: FIXME!  This test has an error
		// Test that the distance between (0,0) and (30,40) is 50.0 (order of parameters matters!)
		assertEquals(5.0, Methods.getDistanceBetween(8, 9, 5, 5), 1e-5);
	}
